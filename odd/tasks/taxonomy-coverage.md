...
- [ ] T5: Seed the taxonomy and exercise the available local API/UI routes; record unavailable environment dependencies precisely. Route: delegated verification.
